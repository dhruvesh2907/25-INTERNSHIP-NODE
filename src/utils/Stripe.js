...
// const stripe = require("stripe")("sk_test_51R9eMUGggoLgE1WDKJ5sVvIwwwrxFLlhkg4KMBnhAp3eSNzIYjKlZej2iRmQNeA0f6DI5bRVRDae3tZRHBnvM50T00EloKciFZ");

// router.post("/create-checkout-session", async (req, res) => {
//     try {
//         const {  hoardingDimension, hourlyRate } = req.body;
